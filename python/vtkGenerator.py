...
def saveData(fileName, x, y, z, kernel):
    ...
    gridToVTK(fileName, x, y, z, pointData={"kernel11_re" : kernReal[0,0,:,:,:], "kernel11_im" : kernImag[0,0,:,:,:], "kernel12_re" : kernReal[0,1,:,:,:], "kernel12_im" : kernImag[0,1,:,:,:], "kernel13_re" : kernReal[0,2,:,:,:], "kernel13_im" : kernImag[0,2,:,:,:], "kernel21_re" : kernReal[1,0,:,:,:], "kernel21_im" : kernImag[1,0,:,:,:], "kernel22_re" : kernReal[1,1,:,:,:], "kernel22_im" : kernImag[1,1,:,:,:], "kernel23_re" : kernReal[1,2,:,:,:], "kernel23_im" : kernImag[1,2,:,:,:], "kernel31_re" : kernReal[2,0,:,:,:], "kernel31_im" : kernImag[2,0,:,:,:], "kernel32_re" : kernReal[2,1,:,:,:], "kernel32_im" : kernImag[2,1,:,:,:], "kernel33_re" : kernReal[2,2,:,:,:], "kernel33_im" : kernImag[2,2,:,:,:], "kernel41_re" : kernReal[3,0,:,:,:], "kernel41_im" : kernImag[3,0,:,:,:], "kernel42_re" : kernReal[3,1,:,:,:], "kernel42_im" : kernImag[3,1,:,:,:], "kernel43_re" : kernReal[3,2,:,:,:], "kernel43_im" : kernImag[3,2,:,:,:]})
    print('done saving')
...
xRange, yRange, zRange, kernel = g3dp.getPoints(resolutionX, resolutionY, resolutionZ, xMax, yMax, zMax, nMax, signCyc, vTOverC, freqRatio, "normal", True)
